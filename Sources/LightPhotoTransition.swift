...
class LightPhotoTransition: UIPercentDrivenInteractiveTransition {
    ...
    weak var lightPhotoBrowser: LightPhotoBrowser?

    // MARK: - Transition

    func transition(_ show: Bool) {
        guard let controller = lightPhotoBrowser else { return }
    ...
    func handlePanGesture(_ gesture: UIPanGestureRecognizer) {
        ...
        case .began:
            interactive = true
            lightPhotoBrowser?.presented = false
            lightPhotoBrowser?.dismiss(animated: true, completion: nil)
        ...
        case .ended, .cancelled:
            ...
            interactive = false
            lightPhotoBrowser?.presented = true
    ...
    override func finish() {
        ...
        guard let lightPhotoBrowser = lightPhotoBrowser else { return }
        lightPhotoBrowser.dismissalDelegate?.lightPhotoBrowserWillDismiss(lightPhotoBrowser)
    }
}

// MARK: - UIViewControllerAnimatedTransitioning

extension LightPhotoTransition: UIViewControllerAnimatedTransitioning {
...
extension LightPhotoTransition: UIViewControllerTransitioningDelegate {
...
extension LightPhotoTransition: UIGestureRecognizerDelegate {
